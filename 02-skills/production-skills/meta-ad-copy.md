---
name: Cuemath Meta Ad Copy
description: Generates 3 production-ready Meta ad copy options with creative copy, platform copy, visual direction, and data-grounded reasoning. Follows MathFit brand framework, ICP segments, and strict character limits.
---
...
- Transformation: Math anxiety -> Math confidence. Passive calculation -> Active reasoning. Fragile memorization -> Deep understanding.
- The Guru-Coach personality: Wise, empowering, trusted, human. NEVER: cheerleader, pressure machine, cold, arrogant.

## BRAND VOICE

- Calm, confident, intelligent — like a trusted advisor
- Sound like a smart friend, not a salesperson
- Use parent's actual language: "understands the why", "patient teacher", "enjoying math now"
- Never jargon like "neuro-adaptive learning pathway"
