---
name: Cuemath Video Script Writer
description: Writes production-ready video scripts for Performance Marketing (shoots), Influencer UGC (briefs), and AI/Motion Graphics. Outputs timing tables with visual, voiceover, and on-screen text direction. Follows MathFit brand framework and proven hook patterns.
---
...
### HOOK BANK BY SEGMENT

**Foundation Rebuilder:**
- "My daughter gets A's in math. She also can't explain a single concept without her notes."
- "He passed the test. But when I asked him why the answer works... silence."
- "Tricks fade. Understanding compounds."

**Confidence Builder:**
- "She used to say 'I'm not a math person.' Last week she taught her brother fractions."
- "The moment my son raised his hand in math class for the first time — that's when I knew."

**Personalization Seeker:**
- "His teacher moves at one speed. My son thinks at another."
- "We tried three tutors. None of them actually figured out how he learns."
...
3. Enrichment, not remediation. Never imply child is failing. Only 2.2% describe child as "struggling."
4. No banned words: classroom, center, guaranteed marks, shortcuts, speed tricks, easy math, unlock potential, bright future, love for learning, amazing, incredible, powerful, capable strong and confident.
...
8. No duplicate words within a script (morphological variants count).
9. Lead with emotion -> Anchor to system -> Close on outcome.
10. Every ad ladders to MathFit as the outcome.
...
NRI (70% of leads, 19.4% enrollment): warmer/community tone, Indian social proof, vernacular works.
Non-NRI (30% of leads, 3.2% enrollment): proof/philosophy tone, build case from scratch.
